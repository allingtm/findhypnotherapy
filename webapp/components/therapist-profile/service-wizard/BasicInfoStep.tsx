    ...
    <div className="space-y-4">
      ...
      <div>
        <Input
          ...
          onBlur={(e) => onBlur?.("short_description", e.target.value)}
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full px-3 py-2 border rounded-lg bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none ${
            errors.description?.[0] ? "border-red-500" : "border-gray-300 dark:border-neutral-600"
          }`}
        />
      ...
      <div>
        <Input
          ...
          onBlur={(e) => onBlur?.("outcome_focus", e.target.value)}
          placeholder="e.g., Quit smoking for good, Reduce anxiety naturally"
          maxLength={200}
          error={errors.outcome_focus?.[0]}
        />
        <p className="-mt-3 mb-4 text-xs text-gray-500 dark:text-gray-400">
