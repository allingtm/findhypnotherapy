...
export function HealthInfoStep({
  ...
  const healthSuffix = healthRequirement === "required" ? " *" : " (optional)";
  const gpSuffix = gpRequirement === "required" ? " *" : " (optional)";
    ...
    <div className="space-y-4">
      ...
      {showHealthInfo && (
        <>
          <div>
            ...
            >
              Health Conditions{healthSuffix}
            </label>
            <textarea
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
            >
              Current Medications{healthSuffix}
            </label>
            <textarea
              id="medications"
      ...
      <div className="bg-gray-50 dark:bg-neutral-800/50 border border-gray-200 dark:border-neutral-700 rounded-lg p-4 mt-6">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          {healthRequirement === "required" || gpRequirement === "required"
            ? "Required fields are marked with *. All other information is optional but helps your therapist provide the best possible care."
            : "All health information is optional but helps your therapist provide the best possible care."}{" "}
