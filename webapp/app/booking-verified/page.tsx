...
export const metadata = {
  title: "Booking Confirmed | Find Hypnotherapy",
  description: "Your booking request has been confirmed",
};
      ...
      <div className="flex-1 bg-gray-50 dark:bg-neutral-950 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white dark:bg-neutral-900 rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            {alreadyVerified ? "Booking Already Verified" : "Booking Request Sent!"}
          </h1>

          <p className="text-gray-600 dark:text-gray-400 mb-6">
            {alreadyVerified
              ? "Your booking has already been verified. The therapist will contact you to confirm your appointment."
              : "Your booking request has been verified and sent to the therapist. They will review your request and confirm your appointment."}
          </p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-200 text-left space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>The therapist will review your booking request</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 bg-blue-200 dark:bg-blue-800 rounded-full flex items-center justify-center text-xs font-medium">
                  2
