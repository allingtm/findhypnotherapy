      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 lg:w-3/4">
          ...
          {initialVideos.length > 0 ? (
            ...
            !showUploadForm && (
              <div className="max-w-md p-8 bg-white dark:bg-neutral-800 rounded-lg shadow">
                <svg
        ...
        <div className="lg:w-1/4">
          <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg sticky top-4">
            <h3 className="font-medium text-blue-900 dark:text-blue-100">
              Tips for Great Videos
            </h3>
            <ul className="mt-2 text-sm text-blue-800 dark:text-blue-200 space-y-1">
              <li>Videos (16:9) can be up to 10 minutes</li>
              <li>Loops (9:16) can be up to 3 minutes</li>
